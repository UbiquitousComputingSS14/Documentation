...
\begin{thebibliography}{999}
	...
	\bibitem{bib:thefourier} \url{https://ccrma.stanford.edu/~jos/mdft/}
	\bibitem{bib:thefourier} \url{http://paulbourke.net/miscellaneous/dft/}
	\bibitem{bib:thefourier} \url{http://www.ignaciomellado.es/blog/Measuring-heart-rate-with-a-smartphone-camera}
	\bibitem{bib:thefourier} \url{http://www-users.cs.york.ac.uk/~fisher/mkfilter/trad.html}
\end{thebibliography}
